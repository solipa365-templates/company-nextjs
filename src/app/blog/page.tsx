...
export const metadata: Metadata = {
  title: "Página do blog | Modelo Next.js gratuito para COMPANYS e SaaS",
  description: "Esta é a página do blog para o modelo COMPANYS Nextjs",
  // other metadata
};
