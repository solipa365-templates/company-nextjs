...
export const metadata: Metadata = {
  title: "Página de detalhes do blog | Modelo Next.js gratuito para COMPANYS e SaaS",
  description: "Esta é a página de detalhes do blog para o modelo COMPANY Nextjs",
  // other metadata
};
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  10 sites incríveis para baixar fotos e ativos digitais
                  de banco de imagens gratuitamente
                </h1>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Dois agora irracional dor em repreender em prazer quer
                    ser uma dor ciliar eu não foge de nada para dar à luz. Excepteur são
                    desejo cego.
                  </p>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    do eiusmod tempor incidente ut labore et dolore magna
                    ...
                    <strong className="text-primary dark:text-white">
                      ...
                      Pellentesque adipiscing comodo elit e imperdiet.
                  </p>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Nem sempre o autor, nem o tempo da vida, nem as crianças.
                    <span className="text-primary underline dark:text-white">
                      {" "}
                      Diz-se que o amor é amor justo.{" "}
                    </span>
                      até para diam. Varius sit amet mattis vulputate por nulla
                      aliquet porttitor. Odio pellentesque diam volutpat commodo
                      sed.
                  </p>
                  <h3 className="font-xl mb-10 líder-tight font-bold text-black sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight escuro:text-white">
                    Mercado digital para designers Ui/Ux.
                  </h3>
                  <p className="text-body-color mb-10 text-base lead-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    ...
                    Consequências de uma mistura de voluptuosidade.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                    Mattis vulputate cupidatat.
                    </li>
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      ...
                      sed do eiusmod incidente utions labore et dolore magna
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Projeto" />
                        <TagButton text="Desenvolvimento" />
                        <TagButton text="Informações" />
                      </div>
                    </div>
                    <div className="mb-5">
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title="A melhor maneira de aumentar suas vendas online."
                  ...
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title="50 melhores dicas e truques de web design que ajudarão você."
                  ...
                  <li>
                    <RelatedPost
                      title="Os 8 melhores construtores de landing pages, analisados"
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <TagButton text="Temas" />
                <TagButton text="Kit de UI" />
                <TagButton text="Tailwind" />
                <TagButton text="Startup" />
                <TagButton text="Negócios" />
                </div>
              </div>
